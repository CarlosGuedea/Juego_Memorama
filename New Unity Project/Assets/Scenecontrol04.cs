...
public class Scenecontrol04 : MonoBehaviour
{
        ...
        for (int i = 0; i < griCols; i++)
        {
            for (int j = 0; j < griRows; j++)
            {
                ...
                else
                {
                    ...
                    card = Instantiate(originalCard) as carta04;
    ...
    private carta04 _firstReveaLed;
    private carta04 _sconReveaLed;
    ...
    public void CardReveaLed(carta04 card)
    {
        if
            (_firstReveaLed == null)
        {
