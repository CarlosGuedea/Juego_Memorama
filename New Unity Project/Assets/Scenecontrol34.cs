...
public class Scenecontrol34 : MonoBehaviour
{
        ...
        for (int i = 0; i < griCols; i++)
        {
            for (int j = 0; j < griRows; j++)
            {
                ...
                else
                {
                    ...
                    card = Instantiate(originalCard) as carta34;
    ...
    private carta34 _firstReveaLed;
    private carta34 _sconReveaLed;
    ...
    public void CardReveaLed(carta34 card)
    {
        if
            (_firstReveaLed == null)
        {
