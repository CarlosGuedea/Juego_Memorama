...
public class Scenecontrol32 : MonoBehaviour
{
        ...
        for (int i = 0; i < griCols; i++)
        {
            for (int j = 0; j < griRows; j++)
            {
                ...
                else
                {
                    ...
                    card = Instantiate(originalCard) as carta32;
    ...
    private carta32 _firstReveaLed;
    private carta32 _sconReveaLed;
    ...
    public void CardReveaLed(carta32 card)
    {
        if
            (_firstReveaLed == null)
        {
