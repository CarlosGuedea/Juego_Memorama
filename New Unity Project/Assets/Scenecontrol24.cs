...
public class Scenecontrol24 : MonoBehaviour
{
        ...
        for (int i = 0; i < griCols; i++)
        {
            for (int j = 0; j < griRows; j++)
            {
                ...
                else
                {
                    ...
                    card = Instantiate(originalCard) as carta24;
    ...
    private carta24 _firstReveaLed;
    private carta24 _sconReveaLed;
    ...
    public void CardReveaLed(carta24 card)
    {
        if
            (_firstReveaLed == null)
        {
