...
public class Scenecontrol33 : MonoBehaviour
{
        ...
        for (int i = 0; i < griCols; i++)
        {
            for (int j = 0; j < griRows; j++)
            {
                ...
                else
                {
                    ...
                    card = Instantiate(originalCard) as carta33;
    ...
    private carta33 _firstReveaLed;
    private carta33 _sconReveaLed;
    ...
    public void CardReveaLed(carta33 card)
    {
        if
            (_firstReveaLed == null)
        {
