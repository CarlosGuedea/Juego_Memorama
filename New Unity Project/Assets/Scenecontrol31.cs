...
public class Scenecontrol31 : MonoBehaviour
{
        ...
        for (int i = 0; i < griCols; i++)
        {
            for (int j = 0; j < griRows; j++)
            {
                ...
                else
                {
                    ...
                    card = Instantiate(originalCard) as carta31;
    ...
    private carta31 _firstReveaLed;
    private carta31 _sconReveaLed;
    ...
    public void CardReveaLed(carta31 card)
    {
        if
            (_firstReveaLed == null)
        {
